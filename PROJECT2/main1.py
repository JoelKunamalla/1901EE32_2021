    ...
    while(len(log)>0 ):
        ...
        while(True):
            ...
            if log[0]==BRAND:
                ...
                if len(xx)>0:
                    l11[0].image(f"./storage1/{xx[0]}",178,250,18,18 , title='transcript')
                if len(xy)>0:
                    l11[0].image(f"./storage2/{xy[0]}",328,250,18,18 , title='transc]]ript')
                l11[0].cell(-158)
...
def generate_all():
    ...
    buu = {"CS": "Computer Science and Engineering", "EE": "Electrical Engineering", "ME": "Mechanical Engineering",
                "CE": "Civil and Environmental Engineering", "CBE": "Chemical and Biochemical Engineering", "MME": "Metallurgical and Materials Engineering"}
    ...
    while(len(log)>0 ):
        l11[0]= FPDF("L" , "mm" ,"A3")
        l11[0].add_page() 
        l11[0].image('./templates/Picture.png' , 9,5,30,25 , title="kk")
        l11[0].image('./templates/Picture.png',375,5,30,25  , title="qwe")
        l11[0].image("./templates/Picture3.png",48,7,300,20  , title="asss")
        l11[0].set_font('times' ,'u',10)
        l11[0].cell(-5.5)
        l11[0].cell(70,45,"INTERIM TRANSCRIPT" )
        l11[0].cell(-66)
        ...
        l11[0].cell(-200)
        l11[0].set_font('times' ,'',12)
        l11[0].cell(0,62,f"{buu[log[0][4:6]]}")
        l11[0].line(5, 110, 410,110)
        l11[0].line(5, 170, 410,170)
        l11[0].line(5, 231, 410,231)
        l11[0].cell(-280)
        ...
        while(True):
            ...
            if log[0]==BRAND:
                ...
                xxx=os.listdir("storage1")
                if(len(xxx)>0):
                    l11[0].image(f"./storage1/{xxx[0]}",178,250,18,18 , title='trscript')
                
                yyy=os.listdir("storage2")
                if len(yyy) >0:
                    l11[0].image(f"./storage2/{yyy[0]}",328,250,18,18 , title='trnscript')
                l11[0].cell(-158)
                l11[0].cell(200,10, joel5)
                l11[0].output(f"./generated/{hh}.pdf")
